...
DATABASES = {
    "default": {
        ...
        "USER": os.getenv("POSTGRES_USER", "helpdesk_user"),
        "PASSWORD": os.getenv("POSTGRES_PASSWORD", "helpdesk_password"),
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Backend foundation for the HelpDesk Ticketing System.",
    "VERSION": "1.0.0",
